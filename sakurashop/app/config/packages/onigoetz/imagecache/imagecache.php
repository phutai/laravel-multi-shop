...
return array(
    ...
    */
    'presets' => array(
        ...
        'X382' => array( //fixed height
            array('action' => 'scale', 'width' => 382)
        ),
        'Y720' => array( //fixed height
            array('action' => 'scale', 'width' => 720)
        ),
        '260X190' => array( //scale to fit inside
            array('action' => 'scale_and_crop', 'height' => 260, 'width' => 190)
        ),
        '274X200' => array( //scale to fit inside
            array('action' => 'scale_and_crop', 'height' => 274, 'width' => 200)
        ),
        '382X522' => array( //scale to fit inside
            array('action' => 'scale_and_crop', 'height' => 522, 'width' => 382)
        ),
    )
);
