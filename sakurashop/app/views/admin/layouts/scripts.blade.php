...
<script src="{{URL::to('/assets/admin/layout2/scripts/layout.js')}}" type="text/javascript"></script>
<script src="{{URL::to('/assets/admin/layout2/scripts/demo.js')}}" type="text/javascript"></script>
